# https://github.com/ashawkey/stable-dreamfusion/blob/d24abd1a6707076d90207b4237c78526f32569fa/guidance/zero123_utils.py
import math
...
class Zero123(nn.Module):
    ...
    def train_step(self, embeddings, pred_rgb, polar, azimuth, radius, guidance_scale=3, as_latent=False, grad_scale=1):
        ...
        t = torch.randint(500, 501, (latents.shape[0],), dtype=torch.long, device=self.device)
...
if __name__ == '__main__':
    ...
    dir_path = "temp_output/teddy_wb_2"
